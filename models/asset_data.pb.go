...
func (m *MarketableAsset) Reset()      { *m = MarketableAsset{} }
func (*MarketableAsset) ProtoMessage() {}
func (*MarketableAsset) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7bd1bc6b244e966, []int{1}
}
func (m *MarketableAsset) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MarketableAsset) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MarketableAsset.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MarketableAsset) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MarketableAsset.Merge(m, src)
}
func (m *MarketableAsset) XXX_Size() int {
	return m.Size()
}
func (m *MarketableAsset) XXX_DiscardUnknown() {
	xxx_messageInfo_MarketableAsset.DiscardUnknown(m)
}

var xxx_messageInfo_MarketableAsset proto.InternalMessageInfo

func (m *MarketableAsset) GetProtocolAsset() *ProtocolAsset {
	if m != nil {
...
func (m *MarketableAsset) GetMarket() *models.Exchange {
	if m != nil {
		return m.Market
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MarketableAsset)(nil), "models.MarketableAsset")
}
...
var fileDescriptor_f7bd1bc6b244e966 = []byte{
	...
	,
}
...
func (this *MarketableAsset) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MarketableAsset)
	if !ok {
		that2, ok := that.(MarketableAsset)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *MarketableAsset) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&models.MarketableAsset{")
...
func (m *MarketableAsset) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MarketableAsset) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MarketableAsset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MarketableAsset) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *MarketableAsset) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&MarketableAsset{`,
...
func (m *MarketableAsset) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MarketableAsset: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MarketableAsset: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
