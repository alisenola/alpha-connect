...
type UPV3Snapshot struct {
	...
	Tick                  []byte                     `protobuf:"bytes,7,opt,name=tick,proto3" json:"tick,omitempty"`
}
...
func (m *UPV3Snapshot) GetTick() []byte {
	if m != nil {
		return m.Tick
	}
	return nil
...
var fileDescriptor_fe080a1ca5f6ba79 = []byte{
	...
	,
}
...
func (this *UPV3Snapshot) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.Tick, that1.Tick) {
		return false
	}
	return true
}
...
func (m *UPV3Snapshot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Tick) > 0 {
		i -= len(m.Tick)
		copy(dAtA[i:], m.Tick)
		i = encodeVarintMarketData(dAtA, i, uint64(len(m.Tick)))
		i--
		dAtA[i] = 0x3a
	}
...
func (m *UPV3Snapshot) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.Tick = append(m.Tick[:0], dAtA[iNdEx:postIndex]...)
			if m.Tick == nil {
				m.Tick = []byte{}
			}
			iNdEx = postIndex
