...
func (m *HistoricalSalesRequest) GetAssetID() uint32 {
	if m != nil {
		return m.AssetID
	}
	return 0
...
type HistoricalSalesResponse struct {
	...
	RejectionReason RejectionReason `protobuf:"varint,7,opt,name=rejection_reason,json=rejectionReason,proto3,enum=messages.RejectionReason" json:"rejection_reason,omitempty"`
}
...
func (m *HistoricalSalesResponse) GetCursor() string {
	if m != nil {
		return m.Cursor
	}
	return ""
...
type MarketableAssetListRequest struct {
	RequestID  uint64     `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	Subscribe  bool       `protobuf:"varint,2,opt,name=subscribe,proto3" json:"subscribe,omitempty"`
	Subscriber *actor.PID `protobuf:"bytes,3,opt,name=subscriber,proto3" json:"subscriber,omitempty"`
}

func (m *MarketableAssetListRequest) Reset()      { *m = MarketableAssetListRequest{} }
func (*MarketableAssetListRequest) ProtoMessage() {}
func (*MarketableAssetListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{68}
}
func (m *MarketableAssetListRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MarketableAssetListRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MarketableAssetListRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MarketableAssetListRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MarketableAssetListRequest.Merge(m, src)
}
func (m *MarketableAssetListRequest) XXX_Size() int {
	return m.Size()
}
func (m *MarketableAssetListRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MarketableAssetListRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MarketableAssetListRequest proto.InternalMessageInfo

func (m *MarketableAssetListRequest) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *MarketableAssetListRequest) GetSubscribe() bool {
	if m != nil {
		return m.Subscribe
	}
	return false
...
func (m *MarketableAssetListRequest) GetSubscriber() *actor.PID {
	if m != nil {
		return m.Subscriber
	}
	return nil
...
type MarketableAssetList struct {
	RequestID        uint64                    `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID       uint64                    `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	MarketableAssets []*models.MarketableAsset `protobuf:"bytes,3,rep,name=marketable_assets,json=marketableAssets,proto3" json:"marketable_assets,omitempty"`
	Success          bool                      `protobuf:"varint,4,opt,name=success,proto3" json:"success,omitempty"`
	RejectionReason  RejectionReason           `protobuf:"varint,5,opt,name=rejection_reason,json=rejectionReason,proto3,enum=messages.RejectionReason" json:"rejection_reason,omitempty"`
}

func (m *MarketableAssetList) Reset()      { *m = MarketableAssetList{} }
func (*MarketableAssetList) ProtoMessage() {}
func (*MarketableAssetList) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{69}
}
func (m *MarketableAssetList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MarketableAssetList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MarketableAssetList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MarketableAssetList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MarketableAssetList.Merge(m, src)
}
func (m *MarketableAssetList) XXX_Size() int {
	return m.Size()
}
func (m *MarketableAssetList) XXX_DiscardUnknown() {
	xxx_messageInfo_MarketableAssetList.DiscardUnknown(m)
}

var xxx_messageInfo_MarketableAssetList proto.InternalMessageInfo

func (m *MarketableAssetList) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *MarketableAssetList) GetResponseID() uint64 {
	if m != nil {
		return m.ResponseID
	}
	return 0
...
func (m *MarketableAssetList) GetMarketableAssets() []*models.MarketableAsset {
	if m != nil {
		return m.MarketableAssets
	}
	return nil
}

func (m *MarketableAssetList) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func (m *MarketableAssetList) GetRejectionReason() RejectionReason {
	if m != nil {
		return m.RejectionReason
	}
	return Other
...
func init() {
	...
	proto.RegisterType((*MarketableAssetListRequest)(nil), "messages.MarketableAssetListRequest")
	proto.RegisterType((*MarketableAssetList)(nil), "messages.MarketableAssetList")
}
...
var fileDescriptor_350c53ba9303a7e6 = []byte{
	...
	,
}
...
func (this *MarketableAssetListRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MarketableAssetListRequest)
	if !ok {
		that2, ok := that.(MarketableAssetListRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *MarketableAssetList) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MarketableAssetList)
	if !ok {
		that2, ok := that.(MarketableAssetList)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.MarketableAssets) != len(that1.MarketableAssets) {
		return false
	}
	for i := range this.MarketableAssets {
		if !this.MarketableAssets[i].Equal(that1.MarketableAssets[i]) {
			return false
		}
	}
	if this.Success != that1.Success {
...
func (this *MarketableAssetListRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&messages.MarketableAssetListRequest{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "Subscribe: "+fmt.Sprintf("%#v", this.Subscribe)+",\n")
	if this.Subscriber != nil {
		s = append(s, "Subscriber: "+fmt.Sprintf("%#v", this.Subscriber)+",\n")
...
func (this *MarketableAssetList) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&messages.MarketableAssetList{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "ResponseID: "+fmt.Sprintf("%#v", this.ResponseID)+",\n")
	if this.MarketableAssets != nil {
		s = append(s, "MarketableAssets: "+fmt.Sprintf("%#v", this.MarketableAssets)+",\n")
	}
	s = append(s, "Success: "+fmt.Sprintf("%#v", this.Success)+",\n")
	s = append(s, "RejectionReason: "+fmt.Sprintf("%#v", this.RejectionReason)+",\n")
	s = append(s, "}")
...
func (m *HistoricalSalesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AssetID != 0 {
		i = encodeVarintExecutorMessages(dAtA, i, uint64(m.AssetID))
		i--
		dAtA[i] = 0x10
	}
	if m.RequestID != 0 {
...
func (m *HistoricalSalesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Cursor) > 0 {
		...
		i = encodeVarintExecutorMessages(dAtA, i, uint64(len(m.Cursor)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Sale) > 0 {
...
func (m *MarketableAssetListRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MarketableAssetListRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MarketableAssetListRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MarketableAssetList) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MarketableAssetList) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MarketableAssetList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.MarketableAssets) > 0 {
		for iNdEx := len(m.MarketableAssets) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.MarketableAssets[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *HistoricalSalesRequest) Size() (n int) {
	...
	if m.AssetID != 0 {
		n += 1 + sovExecutorMessages(uint64(m.AssetID))
	}
	if m.From != nil {
		l = m.From.Size()
		n += 1 + l + sovExecutorMessages(uint64(l))
...
func (m *MarketableAssetListRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MarketableAssetList) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.MarketableAssets) > 0 {
		for _, e := range m.MarketableAssets {
			l = e.Size()
			n += 1 + l + sovExecutorMessages(uint64(l))
		}
	}
...
func (this *MarketableAssetListRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&MarketableAssetListRequest{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`Subscribe:` + fmt.Sprintf("%v", this.Subscribe) + `,`,
		`Subscriber:` + strings.Replace(fmt.Sprintf("%v", this.Subscriber), "PID", "actor.PID", 1) + `,`,
		`}`,
...
func (this *MarketableAssetList) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForMarketableAssets := "[]*MarketableAsset{"
	for _, f := range this.MarketableAssets {
		repeatedStringForMarketableAssets += strings.Replace(fmt.Sprintf("%v", f), "MarketableAsset", "models.MarketableAsset", 1) + ","
	}
	repeatedStringForMarketableAssets += "}"
	s := strings.Join([]string{`&MarketableAssetList{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
		`MarketableAssets:` + repeatedStringForMarketableAssets + `,`,
		`Success:` + fmt.Sprintf("%v", this.Success) + `,`,
		`RejectionReason:` + fmt.Sprintf("%v", this.RejectionReason) + `,`,
		`}`,
	}, "")
...
func (m *MarketableAssetListRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MarketableAssetListRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MarketableAssetListRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *MarketableAssetList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MarketableAssetList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MarketableAssetList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarketableAssets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MarketableAssets = append(m.MarketableAssets, &models.MarketableAsset{})
			if err := m.MarketableAssets[len(m.MarketableAssets)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
