...
type HistoricalUnipoolV3EventRequest struct {
	RequestID  uint64             `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	Instrument *models.Instrument `protobuf:"bytes,2,opt,name=instrument,proto3" json:"instrument,omitempty"`
...
func (m *HistoricalUnipoolV3EventRequest) Reset()      { *m = HistoricalUnipoolV3EventRequest{} }
func (*HistoricalUnipoolV3EventRequest) ProtoMessage() {}
func (*HistoricalUnipoolV3EventRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{4}
}
func (m *HistoricalUnipoolV3EventRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HistoricalUnipoolV3EventRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HistoricalUnipoolV3EventRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HistoricalUnipoolV3EventRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HistoricalUnipoolV3EventRequest.Merge(m, src)
}
func (m *HistoricalUnipoolV3EventRequest) XXX_Size() int {
	return m.Size()
}
func (m *HistoricalUnipoolV3EventRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_HistoricalUnipoolV3EventRequest.DiscardUnknown(m)
}

var xxx_messageInfo_HistoricalUnipoolV3EventRequest proto.InternalMessageInfo

func (m *HistoricalUnipoolV3EventRequest) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *HistoricalUnipoolV3EventRequest) GetInstrument() *models.Instrument {
	if m != nil {
		return m.Instrument
	}
	return nil
...
func (m *HistoricalUnipoolV3EventRequest) GetStart() uint64 {
	if m != nil {
		return m.Start
	}
	return 0
...
func (m *HistoricalUnipoolV3EventRequest) GetEnd() uint64 {
	if m != nil {
		return m.End
	}
	return 0
...
type HistoricalUnipoolV3EventResponse struct {
	RequestID       uint64               `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID      uint64               `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
...
func (m *HistoricalUnipoolV3EventResponse) Reset()      { *m = HistoricalUnipoolV3EventResponse{} }
func (*HistoricalUnipoolV3EventResponse) ProtoMessage() {}
func (*HistoricalUnipoolV3EventResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{5}
}
func (m *HistoricalUnipoolV3EventResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HistoricalUnipoolV3EventResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HistoricalUnipoolV3EventResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HistoricalUnipoolV3EventResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HistoricalUnipoolV3EventResponse.Merge(m, src)
}
func (m *HistoricalUnipoolV3EventResponse) XXX_Size() int {
	return m.Size()
}
func (m *HistoricalUnipoolV3EventResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_HistoricalUnipoolV3EventResponse.DiscardUnknown(m)
}

var xxx_messageInfo_HistoricalUnipoolV3EventResponse proto.InternalMessageInfo

func (m *HistoricalUnipoolV3EventResponse) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *HistoricalUnipoolV3EventResponse) GetResponseID() uint64 {
	if m != nil {
		return m.ResponseID
	}
	return 0
...
func (m *HistoricalUnipoolV3EventResponse) GetEvents() []*models.UPV3Update {
	if m != nil {
		return m.Events
	}
	return nil
...
func (m *HistoricalUnipoolV3EventResponse) GetSeqNum() uint64 {
	if m != nil {
		return m.SeqNum
	}
	return 0
...
func (m *HistoricalUnipoolV3EventResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func (m *HistoricalUnipoolV3EventResponse) GetRejectionReason() RejectionReason {
	if m != nil {
		return m.RejectionReason
	}
	return Other
...
type UnipoolV3DataResponse struct {
	RequestID       uint64               `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID      uint64               `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	Snapshot        *models.UPV3Snapshot `protobuf:"bytes,3,opt,name=snapshot,proto3" json:"snapshot,omitempty"`
	SeqNum          uint64               `protobuf:"varint,4,opt,name=seq_num,json=seqNum,proto3" json:"seq_num,omitempty"`
	Success         bool                 `protobuf:"varint,5,opt,name=success,proto3" json:"success,omitempty"`
	RejectionReason RejectionReason      `protobuf:"varint,6,opt,name=rejection_reason,json=rejectionReason,proto3,enum=messages.RejectionReason" json:"rejection_reason,omitempty"`
}
...
func (m *UnipoolV3DataResponse) GetSnapshot() *models.UPV3Snapshot {
	if m != nil {
		return m.Snapshot
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*HistoricalUnipoolV3EventRequest)(nil), "messages.HistoricalUnipoolV3EventRequest")
	proto.RegisterType((*HistoricalUnipoolV3EventResponse)(nil), "messages.HistoricalUnipoolV3EventResponse")
...
var fileDescriptor_350c53ba9303a7e6 = []byte{
	...
	,
}
...
func (this *HistoricalUnipoolV3EventRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HistoricalUnipoolV3EventRequest)
	if !ok {
		that2, ok := that.(HistoricalUnipoolV3EventRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *HistoricalUnipoolV3EventResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HistoricalUnipoolV3EventResponse)
	if !ok {
		that2, ok := that.(HistoricalUnipoolV3EventResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *HistoricalUnipoolV3EventRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&messages.HistoricalUnipoolV3EventRequest{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	if this.Instrument != nil {
		s = append(s, "Instrument: "+fmt.Sprintf("%#v", this.Instrument)+",\n")
	}
...
func (this *HistoricalUnipoolV3EventResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&messages.HistoricalUnipoolV3EventResponse{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "ResponseID: "+fmt.Sprintf("%#v", this.ResponseID)+",\n")
	if this.Events != nil {
...
func (m *HistoricalUnipoolV3EventRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HistoricalUnipoolV3EventRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HistoricalUnipoolV3EventRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *HistoricalUnipoolV3EventResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HistoricalUnipoolV3EventResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HistoricalUnipoolV3EventResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MarketStatisticsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Statistics) > 0 {
		dAtA9 := make([]byte, len(m.Statistics)*10)
		var j8 int
		...
		i = encodeVarintExecutorMessages(dAtA, i, uint64(j8))
		i--
		dAtA[i] = 0x1a
	}
	if m.Instrument != nil {
...
func (m *MarketDataRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Stats) > 0 {
		dAtA12 := make([]byte, len(m.Stats)*10)
		var j11 int
...
func (m *HistoricalUnipoolV3EventRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HistoricalUnipoolV3EventResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *HistoricalUnipoolV3EventRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HistoricalUnipoolV3EventRequest{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`Instrument:` + strings.Replace(fmt.Sprintf("%v", this.Instrument), "Instrument", "models.Instrument", 1) + `,`,
...
func (this *HistoricalUnipoolV3EventResponse) String() string {
	if this == nil {
		return "nil"
	}
	...
	s := strings.Join([]string{`&HistoricalUnipoolV3EventResponse{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
...
func (this *UnipoolV3DataResponse) String() string {
	...
	s := strings.Join([]string{`&UnipoolV3DataResponse{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
		`Snapshot:` + strings.Replace(fmt.Sprintf("%v", this.Snapshot), "UPV3Snapshot", "models.UPV3Snapshot", 1) + `,`,
		`SeqNum:` + fmt.Sprintf("%v", this.SeqNum) + `,`,
		`Success:` + fmt.Sprintf("%v", this.Success) + `,`,
		`RejectionReason:` + fmt.Sprintf("%v", this.RejectionReason) + `,`,
		`}`,
...
func (m *HistoricalUnipoolV3EventRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HistoricalUnipoolV3EventRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HistoricalUnipoolV3EventRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *HistoricalUnipoolV3EventResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HistoricalUnipoolV3EventResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HistoricalUnipoolV3EventResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *UnipoolV3DataResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Snapshot == nil {
				m.Snapshot = &models.UPV3Snapshot{}
			}
