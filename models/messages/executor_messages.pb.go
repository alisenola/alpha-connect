...
type NewBulkOrderRequest struct {
}

func (m *NewBulkOrderRequest) Reset()      { *m = NewBulkOrderRequest{} }
func (*NewBulkOrderRequest) ProtoMessage() {}
func (*NewBulkOrderRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{14}
}
func (m *NewBulkOrderRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NewBulkOrderRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NewBulkOrderRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *NewBulkOrderRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewBulkOrderRequest.Merge(m, src)
}
func (m *NewBulkOrderRequest) XXX_Size() int {
	return m.Size()
}
func (m *NewBulkOrderRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_NewBulkOrderRequest.DiscardUnknown(m)
}

var xxx_messageInfo_NewBulkOrderRequest proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*NewBulkOrderRequest)(nil), "messages.NewBulkOrderRequest")
...
var fileDescriptor_350c53ba9303a7e6 = []byte{
	...
	,
}
...
func (this *NewBulkOrderRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*NewBulkOrderRequest)
	if !ok {
		that2, ok := that.(NewBulkOrderRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *NewBulkOrderRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&messages.NewBulkOrderRequest{")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *NewBulkOrderRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *NewBulkOrderRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *NewBulkOrderRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *NewBulkOrderRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&NewBulkOrderRequest{`,
		`}`,
	}, "")
	return s
}
...
func (m *NewBulkOrderRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NewBulkOrderRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NewBulkOrderRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
