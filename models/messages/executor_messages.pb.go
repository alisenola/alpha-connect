...
const (
	...
	MissingAsset                   RejectionReason = 31
	UnknownAsset                   RejectionReason = 32
)
...
type HistoricalAssetTransferRequest struct {
	RequestID uint64                `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	Asset     *models.ProtocolAsset `protobuf:"bytes,2,opt,name=asset,proto3" json:"asset,omitempty"`
	Start     uint64                `protobuf:"varint,3,opt,name=start,proto3" json:"start,omitempty"`
	Stop      uint64                `protobuf:"varint,4,opt,name=stop,proto3" json:"stop,omitempty"`
}

func (m *HistoricalAssetTransferRequest) Reset()      { *m = HistoricalAssetTransferRequest{} }
func (*HistoricalAssetTransferRequest) ProtoMessage() {}
func (*HistoricalAssetTransferRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{6}
}
func (m *HistoricalAssetTransferRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HistoricalAssetTransferRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HistoricalAssetTransferRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HistoricalAssetTransferRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HistoricalAssetTransferRequest.Merge(m, src)
}
func (m *HistoricalAssetTransferRequest) XXX_Size() int {
	return m.Size()
}
func (m *HistoricalAssetTransferRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_HistoricalAssetTransferRequest.DiscardUnknown(m)
}

var xxx_messageInfo_HistoricalAssetTransferRequest proto.InternalMessageInfo

func (m *HistoricalAssetTransferRequest) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *HistoricalAssetTransferRequest) GetAsset() *models.ProtocolAsset {
	if m != nil {
		return m.Asset
	}
	return nil
...
func (m *HistoricalAssetTransferRequest) GetStart() uint64 {
	if m != nil {
		return m.Start
	}
	return 0
...
func (m *HistoricalAssetTransferRequest) GetStop() uint64 {
	if m != nil {
		return m.Stop
	}
	return 0
...
type HistoricalAssetTransferResponse struct {
	RequestID       uint64                `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID      uint64                `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	Transfers       []*models.AssetUpdate `protobuf:"bytes,3,rep,name=transfers,proto3" json:"transfers,omitempty"`
	SeqNum          uint64                `protobuf:"varint,4,opt,name=seq_num,json=seqNum,proto3" json:"seq_num,omitempty"`
	Success         bool                  `protobuf:"varint,5,opt,name=success,proto3" json:"success,omitempty"`
	RejectionReason RejectionReason       `protobuf:"varint,6,opt,name=rejection_reason,json=rejectionReason,proto3,enum=messages.RejectionReason" json:"rejection_reason,omitempty"`
}

func (m *HistoricalAssetTransferResponse) Reset()      { *m = HistoricalAssetTransferResponse{} }
func (*HistoricalAssetTransferResponse) ProtoMessage() {}
func (*HistoricalAssetTransferResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{7}
}
func (m *HistoricalAssetTransferResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HistoricalAssetTransferResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HistoricalAssetTransferResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HistoricalAssetTransferResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HistoricalAssetTransferResponse.Merge(m, src)
}
func (m *HistoricalAssetTransferResponse) XXX_Size() int {
	return m.Size()
}
func (m *HistoricalAssetTransferResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_HistoricalAssetTransferResponse.DiscardUnknown(m)
}

var xxx_messageInfo_HistoricalAssetTransferResponse proto.InternalMessageInfo

func (m *HistoricalAssetTransferResponse) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *HistoricalAssetTransferResponse) GetResponseID() uint64 {
	if m != nil {
		return m.ResponseID
	}
	return 0
...
func (m *HistoricalAssetTransferResponse) GetTransfers() []*models.AssetUpdate {
	if m != nil {
		return m.Transfers
	}
	return nil
...
func (m *HistoricalAssetTransferResponse) GetSeqNum() uint64 {
	if m != nil {
		return m.SeqNum
	}
	return 0
...
func (m *HistoricalAssetTransferResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func (m *HistoricalAssetTransferResponse) GetRejectionReason() RejectionReason {
	if m != nil {
		return m.RejectionReason
	}
	return Other
...
type AssetTransferRequest struct {
	...
	Subscribe  bool                  `protobuf:"varint,2,opt,name=subscribe,proto3" json:"subscribe,omitempty"`
	Subscriber *actor.PID            `protobuf:"bytes,3,opt,name=subscriber,proto3" json:"subscriber,omitempty"`
	Asset      *models.ProtocolAsset `protobuf:"bytes,4,opt,name=asset,proto3" json:"asset,omitempty"`
}

func (m *AssetTransferRequest) Reset()      { *m = AssetTransferRequest{} }
...
func (m *AssetTransferRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AssetTransferRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AssetTransferRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AssetTransferRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssetTransferRequest.Merge(m, src)
}
func (m *AssetTransferRequest) XXX_Size() int {
	return m.Size()
}
func (m *AssetTransferRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_AssetTransferRequest.DiscardUnknown(m)
}

var xxx_messageInfo_AssetTransferRequest proto.InternalMessageInfo

func (m *AssetTransferRequest) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *AssetTransferRequest) GetSubscribe() bool {
	if m != nil {
		return m.Subscribe
	}
	return false
...
func (m *AssetTransferRequest) GetSubscriber() *actor.PID {
	if m != nil {
		return m.Subscriber
	}
	return nil
...
func (m *AssetTransferRequest) GetAsset() *models.ProtocolAsset {
	if m != nil {
		return m.Asset
	}
	return nil
...
type AssetTransferResponse struct {
	RequestID       uint64                `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID      uint64                `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	AssetUpdated    []*models.AssetUpdate `protobuf:"bytes,3,rep,name=asset_updated,json=assetUpdated,proto3" json:"asset_updated,omitempty"`
	SeqNum          uint64                `protobuf:"varint,4,opt,name=seq_num,json=seqNum,proto3" json:"seq_num,omitempty"`
	Success         bool                  `protobuf:"varint,5,opt,name=success,proto3" json:"success,omitempty"`
	RejectionReason RejectionReason       `protobuf:"varint,6,opt,name=rejection_reason,json=rejectionReason,proto3,enum=messages.RejectionReason" json:"rejection_reason,omitempty"`
}

func (m *AssetTransferResponse) Reset()      { *m = AssetTransferResponse{} }
...
func (m *AssetTransferResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AssetTransferResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AssetTransferResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AssetTransferResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssetTransferResponse.Merge(m, src)
}
func (m *AssetTransferResponse) XXX_Size() int {
	return m.Size()
}
func (m *AssetTransferResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AssetTransferResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AssetTransferResponse proto.InternalMessageInfo

func (m *AssetTransferResponse) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *AssetTransferResponse) GetResponseID() uint64 {
	if m != nil {
		return m.ResponseID
	}
	return 0
...
func (m *AssetTransferResponse) GetAssetUpdated() []*models.AssetUpdate {
	if m != nil {
		return m.AssetUpdated
	}
	return nil
}

func (m *AssetTransferResponse) GetSeqNum() uint64 {
	if m != nil {
		return m.SeqNum
	}
	return 0
...
func (m *AssetTransferResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func (m *AssetTransferResponse) GetRejectionReason() RejectionReason {
	if m != nil {
		return m.RejectionReason
	}
	return Other
...
type AssetDataIncrementalRefresh struct {
	RequestID  uint64              `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID uint64              `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	SeqNum     uint64              `protobuf:"varint,3,opt,name=seq_num,json=seqNum,proto3" json:"seq_num,omitempty"`
	Update     *models.AssetUpdate `protobuf:"bytes,4,opt,name=update,proto3" json:"update,omitempty"`
}

func (m *AssetDataIncrementalRefresh) Reset()      { *m = AssetDataIncrementalRefresh{} }
func (*AssetDataIncrementalRefresh) ProtoMessage() {}
func (*AssetDataIncrementalRefresh) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{18}
}
func (m *AssetDataIncrementalRefresh) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AssetDataIncrementalRefresh) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AssetDataIncrementalRefresh.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AssetDataIncrementalRefresh) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssetDataIncrementalRefresh.Merge(m, src)
}
func (m *AssetDataIncrementalRefresh) XXX_Size() int {
	return m.Size()
}
func (m *AssetDataIncrementalRefresh) XXX_DiscardUnknown() {
	xxx_messageInfo_AssetDataIncrementalRefresh.DiscardUnknown(m)
}

var xxx_messageInfo_AssetDataIncrementalRefresh proto.InternalMessageInfo

func (m *AssetDataIncrementalRefresh) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *AssetDataIncrementalRefresh) GetResponseID() uint64 {
	if m != nil {
		return m.ResponseID
	}
	return 0
...
func (m *AssetDataIncrementalRefresh) GetSeqNum() uint64 {
	if m != nil {
		return m.SeqNum
	}
	return 0
...
func (m *AssetDataIncrementalRefresh) GetUpdate() *models.AssetUpdate {
	if m != nil {
		return m.Update
	}
	return nil
...
func (m *AssetListRequest) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *AssetListRequest) GetSubscribe() bool {
	if m != nil {
		return m.Subscribe
	}
	return false
...
func (m *AssetListRequest) GetSubscriber() *actor.PID {
	if m != nil {
		return m.Subscriber
	}
	return nil
...
type AssetListResponse struct {
	RequestID       uint64                  `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID      uint64                  `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	Assets          []*models.ProtocolAsset `protobuf:"bytes,3,rep,name=assets,proto3" json:"assets,omitempty"`
	Success         bool                    `protobuf:"varint,4,opt,name=success,proto3" json:"success,omitempty"`
	RejectionReason RejectionReason         `protobuf:"varint,5,opt,name=rejection_reason,json=rejectionReason,proto3,enum=messages.RejectionReason" json:"rejection_reason,omitempty"`
}
...
func (m *AssetListResponse) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *AssetListResponse) GetResponseID() uint64 {
	if m != nil {
		return m.ResponseID
	}
	return 0
...
func (m *AssetListResponse) GetAssets() []*models.ProtocolAsset {
	if m != nil {
		return m.Assets
	}
	return nil
...
func (m *AssetListResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func (m *AssetListResponse) GetRejectionReason() RejectionReason {
	if m != nil {
		return m.RejectionReason
	}
	return Other
...
func (m *AssetList) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *AssetList) GetResponseID() uint64 {
	if m != nil {
		return m.ResponseID
	}
	return 0
...
func (m *AssetList) GetAssets() []*models.ProtocolAsset {
	if m != nil {
		return m.Assets
	}
	return nil
...
func (m *AssetList) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func (m *AssetList) GetRejectionReason() RejectionReason {
	if m != nil {
		return m.RejectionReason
	}
	return Other
...
func init() {
	...
	proto.RegisterType((*HistoricalAssetTransferRequest)(nil), "messages.HistoricalAssetTransferRequest")
	proto.RegisterType((*HistoricalAssetTransferResponse)(nil), "messages.HistoricalAssetTransferResponse")
	...
	proto.RegisterType((*AssetTransferRequest)(nil), "messages.AssetTransferRequest")
	proto.RegisterType((*AssetTransferResponse)(nil), "messages.AssetTransferResponse")
	proto.RegisterType((*UnipoolV3DataIncrementalRefresh)(nil), "messages.UnipoolV3DataIncrementalRefresh")
	proto.RegisterType((*AssetDataIncrementalRefresh)(nil), "messages.AssetDataIncrementalRefresh")
	...
	proto.RegisterType((*AssetListRequest)(nil), "messages.AssetListRequest")
	proto.RegisterType((*AssetListResponse)(nil), "messages.AssetListResponse")
	proto.RegisterType((*AssetList)(nil), "messages.AssetList")
}
...
var fileDescriptor_350c53ba9303a7e6 = []byte{
	...
	,
}
...
func (this *HistoricalAssetTransferRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HistoricalAssetTransferRequest)
	if !ok {
		that2, ok := that.(HistoricalAssetTransferRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *HistoricalAssetTransferResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*HistoricalAssetTransferResponse)
	if !ok {
		that2, ok := that.(HistoricalAssetTransferResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AssetTransferRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AssetTransferRequest)
	if !ok {
		that2, ok := that.(AssetTransferRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AssetTransferResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AssetTransferResponse)
	if !ok {
		that2, ok := that.(AssetTransferResponse)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.AssetUpdated) != len(that1.AssetUpdated) {
		return false
	}
	for i := range this.AssetUpdated {
		if !this.AssetUpdated[i].Equal(that1.AssetUpdated[i]) {
			return false
		}
	}
	if this.SeqNum != that1.SeqNum {
...
func (this *AssetDataIncrementalRefresh) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AssetDataIncrementalRefresh)
	if !ok {
		that2, ok := that.(AssetDataIncrementalRefresh)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AssetListRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AssetListRequest)
	if !ok {
		that2, ok := that.(AssetListRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AssetListResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AssetListResponse)
	if !ok {
		that2, ok := that.(AssetListResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *HistoricalAssetTransferRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&messages.HistoricalAssetTransferRequest{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	if this.Asset != nil {
...
func (this *HistoricalAssetTransferResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&messages.HistoricalAssetTransferResponse{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "ResponseID: "+fmt.Sprintf("%#v", this.ResponseID)+",\n")
...
func (this *AssetTransferRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&messages.AssetTransferRequest{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "Subscribe: "+fmt.Sprintf("%#v", this.Subscribe)+",\n")
	if this.Subscriber != nil {
		s = append(s, "Subscriber: "+fmt.Sprintf("%#v", this.Subscriber)+",\n")
...
func (this *AssetTransferResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&messages.AssetTransferResponse{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "ResponseID: "+fmt.Sprintf("%#v", this.ResponseID)+",\n")
	if this.AssetUpdated != nil {
		s = append(s, "AssetUpdated: "+fmt.Sprintf("%#v", this.AssetUpdated)+",\n")
	}
	s = append(s, "SeqNum: "+fmt.Sprintf("%#v", this.SeqNum)+",\n")
	s = append(s, "Success: "+fmt.Sprintf("%#v", this.Success)+",\n")
	s = append(s, "RejectionReason: "+fmt.Sprintf("%#v", this.RejectionReason)+",\n")
...
func (this *AssetDataIncrementalRefresh) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&messages.AssetDataIncrementalRefresh{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "ResponseID: "+fmt.Sprintf("%#v", this.ResponseID)+",\n")
	s = append(s, "SeqNum: "+fmt.Sprintf("%#v", this.SeqNum)+",\n")
	if this.Update != nil {
...
func (this *AssetListRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&messages.AssetListRequest{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "Subscribe: "+fmt.Sprintf("%#v", this.Subscribe)+",\n")
	if this.Subscriber != nil {
		s = append(s, "Subscriber: "+fmt.Sprintf("%#v", this.Subscriber)+",\n")
...
func (this *AssetListResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&messages.AssetListResponse{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "ResponseID: "+fmt.Sprintf("%#v", this.ResponseID)+",\n")
	if this.Assets != nil {
...
func (this *AssetList) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&messages.AssetList{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "ResponseID: "+fmt.Sprintf("%#v", this.ResponseID)+",\n")
	if this.Assets != nil {
		s = append(s, "Assets: "+fmt.Sprintf("%#v", this.Assets)+",\n")
...
func (m *HistoricalAssetTransferRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HistoricalAssetTransferRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HistoricalAssetTransferRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *HistoricalAssetTransferResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HistoricalAssetTransferResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HistoricalAssetTransferResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AssetTransferRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AssetTransferRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AssetTransferRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AssetTransferResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AssetTransferResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AssetTransferResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.AssetUpdated) > 0 {
		for iNdEx := len(m.AssetUpdated) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AssetUpdated[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *AssetDataIncrementalRefresh) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AssetDataIncrementalRefresh) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AssetDataIncrementalRefresh) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *HistoricalAssetTransferRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *HistoricalAssetTransferResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AssetTransferRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AssetTransferResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AssetDataIncrementalRefresh) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *HistoricalAssetTransferRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&HistoricalAssetTransferRequest{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`Asset:` + strings.Replace(fmt.Sprintf("%v", this.Asset), "ProtocolAsset", "models.ProtocolAsset", 1) + `,`,
		`Start:` + fmt.Sprintf("%v", this.Start) + `,`,
...
func (this *HistoricalAssetTransferResponse) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForTransfers := "[]*AssetUpdate{"
	for _, f := range this.Transfers {
		repeatedStringForTransfers += strings.Replace(fmt.Sprintf("%v", f), "AssetUpdate", "models.AssetUpdate", 1) + ","
	}
	repeatedStringForTransfers += "}"
	s := strings.Join([]string{`&HistoricalAssetTransferResponse{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
...
func (this *AssetTransferRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AssetTransferRequest{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`Subscribe:` + fmt.Sprintf("%v", this.Subscribe) + `,`,
		`Subscriber:` + strings.Replace(fmt.Sprintf("%v", this.Subscriber), "PID", "actor.PID", 1) + `,`,
		`Asset:` + strings.Replace(fmt.Sprintf("%v", this.Asset), "ProtocolAsset", "models.ProtocolAsset", 1) + `,`,
...
func (this *AssetTransferResponse) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForAssetUpdated := "[]*AssetUpdate{"
	for _, f := range this.AssetUpdated {
		repeatedStringForAssetUpdated += strings.Replace(fmt.Sprintf("%v", f), "AssetUpdate", "models.AssetUpdate", 1) + ","
	}
	repeatedStringForAssetUpdated += "}"
	s := strings.Join([]string{`&AssetTransferResponse{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
		`AssetUpdated:` + repeatedStringForAssetUpdated + `,`,
		`SeqNum:` + fmt.Sprintf("%v", this.SeqNum) + `,`,
		`Success:` + fmt.Sprintf("%v", this.Success) + `,`,
		`RejectionReason:` + fmt.Sprintf("%v", this.RejectionReason) + `,`,
		`}`,
...
func (this *AssetDataIncrementalRefresh) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AssetDataIncrementalRefresh{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
		`SeqNum:` + fmt.Sprintf("%v", this.SeqNum) + `,`,
		`Update:` + strings.Replace(fmt.Sprintf("%v", this.Update), "AssetUpdate", "models.AssetUpdate", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *AssetListRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AssetListRequest{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`Subscribe:` + fmt.Sprintf("%v", this.Subscribe) + `,`,
		`Subscriber:` + strings.Replace(fmt.Sprintf("%v", this.Subscriber), "PID", "actor.PID", 1) + `,`,
		`}`,
...
func (this *AssetListResponse) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForAssets := "[]*ProtocolAsset{"
	for _, f := range this.Assets {
		repeatedStringForAssets += strings.Replace(fmt.Sprintf("%v", f), "ProtocolAsset", "models.ProtocolAsset", 1) + ","
	}
	repeatedStringForAssets += "}"
	s := strings.Join([]string{`&AssetListResponse{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
...
func (this *AssetList) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForAssets := "[]*ProtocolAsset{"
	...
	repeatedStringForAssets += "}"
	s := strings.Join([]string{`&AssetList{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
		`Assets:` + repeatedStringForAssets + `,`,
		`Success:` + fmt.Sprintf("%v", this.Success) + `,`,
...
func (m *HistoricalAssetTransferRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HistoricalAssetTransferRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HistoricalAssetTransferRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *HistoricalAssetTransferResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HistoricalAssetTransferResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HistoricalAssetTransferResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			m.Transfers = append(m.Transfers, &models.AssetUpdate{})
...
func (m *AssetTransferRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AssetTransferRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AssetTransferRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *AssetTransferResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AssetTransferResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AssetTransferResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AssetUpdated", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AssetUpdated = append(m.AssetUpdated, &models.AssetUpdate{})
			if err := m.AssetUpdated[len(m.AssetUpdated)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *AssetDataIncrementalRefresh) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AssetDataIncrementalRefresh: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AssetDataIncrementalRefresh: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *AssetListResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Assets = append(m.Assets, &models.ProtocolAsset{})
