...
func (m *HistoricalAssetTransferRequest) GetCollection() *models.Collection {
	if m != nil {
		return m.Collection
	}
	return nil
...
type HistoricalAssetTransferResponse struct {
	RequestID       uint64                  `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID      uint64                  `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	Transfers       []*models.AssetTransfer `protobuf:"bytes,3,rep,name=transfers,proto3" json:"transfers,omitempty"`
	SeqNum          uint64                  `protobuf:"varint,4,opt,name=seq_num,json=seqNum,proto3" json:"seq_num,omitempty"`
	Success         bool                    `protobuf:"varint,5,opt,name=success,proto3" json:"success,omitempty"`
	RejectionReason RejectionReason         `protobuf:"varint,6,opt,name=rejection_reason,json=rejectionReason,proto3,enum=messages.RejectionReason" json:"rejection_reason,omitempty"`
}
...
func (m *HistoricalAssetTransferResponse) GetTransfers() []*models.AssetTransfer {
	if m != nil {
		return m.Transfers
	}
	return nil
...
type Erc721DataIncrementalRefresh struct {
	RequestID  uint64                `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID uint64                `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	SeqNum     uint64                `protobuf:"varint,3,opt,name=seq_num,json=seqNum,proto3" json:"seq_num,omitempty"`
	Update     *models.AssetTransfer `protobuf:"bytes,4,opt,name=update,proto3" json:"update,omitempty"`
}

func (m *Erc721DataIncrementalRefresh) Reset()      { *m = Erc721DataIncrementalRefresh{} }
func (*Erc721DataIncrementalRefresh) ProtoMessage() {}
func (*Erc721DataIncrementalRefresh) Descriptor() ([]byte, []int) {
	return fileDescriptor_350c53ba9303a7e6, []int{16}
}
func (m *Erc721DataIncrementalRefresh) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Erc721DataIncrementalRefresh) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Erc721DataIncrementalRefresh.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Erc721DataIncrementalRefresh) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Erc721DataIncrementalRefresh.Merge(m, src)
}
func (m *Erc721DataIncrementalRefresh) XXX_Size() int {
	return m.Size()
}
func (m *Erc721DataIncrementalRefresh) XXX_DiscardUnknown() {
	xxx_messageInfo_Erc721DataIncrementalRefresh.DiscardUnknown(m)
}

var xxx_messageInfo_Erc721DataIncrementalRefresh proto.InternalMessageInfo

func (m *Erc721DataIncrementalRefresh) GetRequestID() uint64 {
	if m != nil {
		return m.RequestID
	}
	return 0
...
func (m *Erc721DataIncrementalRefresh) GetResponseID() uint64 {
	if m != nil {
		return m.ResponseID
	}
	return 0
...
func (m *Erc721DataIncrementalRefresh) GetSeqNum() uint64 {
	if m != nil {
		return m.SeqNum
	}
	return 0
...
func (m *Erc721DataIncrementalRefresh) GetUpdate() *models.AssetTransfer {
	if m != nil {
		return m.Update
	}
	return nil
...
type AssetListResponse struct {
	RequestID       uint64               `protobuf:"varint,1,opt,name=requestID,proto3" json:"requestID,omitempty"`
	ResponseID      uint64               `protobuf:"varint,2,opt,name=responseID,proto3" json:"responseID,omitempty"`
	Collections     []*models.Collection `protobuf:"bytes,3,rep,name=collections,proto3" json:"collections,omitempty"`
	Success         bool                 `protobuf:"varint,4,opt,name=success,proto3" json:"success,omitempty"`
	RejectionReason RejectionReason      `protobuf:"varint,5,opt,name=rejection_reason,json=rejectionReason,proto3,enum=messages.RejectionReason" json:"rejection_reason,omitempty"`
}
...
func (m *AssetListResponse) GetCollections() []*models.Collection {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Erc721DataIncrementalRefresh)(nil), "messages.Erc721DataIncrementalRefresh")
...
var fileDescriptor_350c53ba9303a7e6 = []byte{
	...
	,
}
...
func (this *Erc721DataIncrementalRefresh) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Erc721DataIncrementalRefresh)
	if !ok {
		that2, ok := that.(Erc721DataIncrementalRefresh)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Erc721DataIncrementalRefresh) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&messages.Erc721DataIncrementalRefresh{")
	s = append(s, "RequestID: "+fmt.Sprintf("%#v", this.RequestID)+",\n")
	s = append(s, "ResponseID: "+fmt.Sprintf("%#v", this.ResponseID)+",\n")
	s = append(s, "SeqNum: "+fmt.Sprintf("%#v", this.SeqNum)+",\n")
	if this.Update != nil {
...
func (m *Erc721DataIncrementalRefresh) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Erc721DataIncrementalRefresh) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Erc721DataIncrementalRefresh) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Erc721DataIncrementalRefresh) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *HistoricalAssetTransferResponse) String() string {
	...
	repeatedStringForTransfers := "[]*AssetTransfer{"
	for _, f := range this.Transfers {
		repeatedStringForTransfers += strings.Replace(fmt.Sprintf("%v", f), "AssetTransfer", "models.AssetTransfer", 1) + ","
	}
...
func (this *Erc721DataIncrementalRefresh) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Erc721DataIncrementalRefresh{`,
		`RequestID:` + fmt.Sprintf("%v", this.RequestID) + `,`,
		`ResponseID:` + fmt.Sprintf("%v", this.ResponseID) + `,`,
		`SeqNum:` + fmt.Sprintf("%v", this.SeqNum) + `,`,
		`Update:` + strings.Replace(fmt.Sprintf("%v", this.Update), "AssetTransfer", "models.AssetTransfer", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *AssetListResponse) String() string {
	...
	repeatedStringForCollections := "[]*Collection{"
	for _, f := range this.Collections {
		repeatedStringForCollections += strings.Replace(fmt.Sprintf("%v", f), "Collection", "models.Collection", 1) + ","
	}
...
func (m *HistoricalAssetTransferResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Transfers = append(m.Transfers, &models.AssetTransfer{})
...
func (m *Erc721DataIncrementalRefresh) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Erc721DataIncrementalRefresh: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Erc721DataIncrementalRefresh: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *AssetListResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Collections = append(m.Collections, &models.Collection{})
